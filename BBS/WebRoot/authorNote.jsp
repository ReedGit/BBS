...
<body>
	...
	<center>
		...
		<a class="maroon"
			href="authorNoteAction.action?userId=<%=request.getParameter("userId")%>pageNumber=1">首页</a>
		<a class="maroon"
			href="authorNoteAction.action?userId=<%=request.getParameter("userId")%>&pageNumber=<s:property value="pageNumber-1"/>">上一页</a>
		<a class="maroon"
			href="authorNoteAction.action?userId=<%=request.getParameter("userId")%>&pageNumber=<s:property value="pageNumber+1"/>">下一页</a>
		<a class="maroon"
			href="authorNoteAction.action?userId=<%=request.getParameter("userId")%>&pageNumber=<s:property value="totalPage"/>">末页</a>
	</center>
